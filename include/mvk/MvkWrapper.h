...
class MvkWrapper {
   ...
   public:
     ...
     */
    int connect(const std::string& ip, const int port, const std::string& username, const std::string& pswd);
   ...
   public:
     ...
     * \return -1 if there is a detected error.
     */
    int modelAdd(const std::string& name, const std::string& mmodel, const std::string& syntax);
   ...
   public:
     ...
     * \return -1 if there is a detected error.
     */
    int edgeCreate(const std::string& type, const std::string& name, const std::string& from, const std::string& to);
     ...
     * \return -1 if there is a detected error.
     */
    int attributeSet(const std::string& element, const std::string& attrType, const std::string& attrValue);
     ...
     * \return -1 if there is a detected error.
     */
    int attributeDefine(const std::string& element, const std::string& attrType, const std::string& attrName);

    /**
     * TODO: This methods is not validated yet, don't use it.
     * \pre Being in modeling mode
     */
    int attributeSetCode(const std::string& element, const std::string& attrType, const std::string& attrName);
