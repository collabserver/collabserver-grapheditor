...
class ObserverMock : public collabserver::CollabDataOperationObserver {
   private:
    HandlerMock _handler;

   public:
    void onOperation(const collabserver::CollabDataOperation& op) override { op.accept(_handler); }
};
