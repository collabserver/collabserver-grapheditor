...
void Timestamp::setEffectiveID(const unsigned int id) { Timestamp::_effectiveID = id; }
...
bool operator==(const Timestamp& rhs, const Timestamp& lhs) { return (rhs._time == lhs._time) && (rhs._id == lhs._id); }
