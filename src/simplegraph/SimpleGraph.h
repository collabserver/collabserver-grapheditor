 ...
 * CollabDataOperation, OperationObserver and broadcaster.
 *
 * \par Thread-Safe
 ...
 * \see Timestamp
 */
class SimpleGraph : public collabserver::CollabData {
    // -------------------------------------------------------------------------
    // Typedefs / Attributes
    // -------------------------------------------------------------------------
   ...
   private:
    typedef collabserver::LWWSet<UUID, Timestamp> _EdgeSet;
    typedef collabserver::LWWRegister<std::string, Timestamp> _Attribute;
    typedef collabserver::LWWMap<std::string, _Attribute, Timestamp> _AttributeMap;
    typedef collabserver::LWWGraph<UUID, _AttributeMap, Timestamp> _Graph;
   ...
   public:
    ...
    /**
     * List all possible CollabDataOperation on this data.
     * Each enum element is the CollabDataOperation's unique ID for this data.
     */
   ...
   public:
    /**
     * Add vertex in graph.
     * Notifies all CollabDataOperationObservers and broadcaster.
     *
     ...
     */
    void addAttribute(const UUID& id, const std::string& name, const std::string& value);
     ...
     */
    void setAttribute(const UUID& id, const std::string& name, const std::string& value);

    // -------------------------------------------------------------------------
    // CollabDataOperation Methods (internal use)
    // -------------------------------------------------------------------------
...
class SimpleGraph::VertexIterator {
   ...
   private:
    friend SimpleGraph;
    VertexIterator(const _Graph& graph) : _data(graph), _it(graph.cbegin()) {}
...
class SimpleGraph::AttributeIterator {
   ...
   private:
    friend SimpleGraph;
    AttributeIterator(const _AttributeMap& map) : _data(map), _it(map.begin()) {}
...
class SimpleGraph::AttributeDescriptor {
   ...
   private:
    friend SimpleGraph;
    AttributeDescriptor(const std::string& name, const std::string& value) : _name(name), _value(value) {}
...
class SimpleGraph::VertexDescriptor {
   ...
   private:
    friend SimpleGraph;
    VertexDescriptor(const UUID& id, const _AttributeMap& attributes, const _EdgeSet& edges);
...
class SimpleGraph::OpHandler : public collabserver::CollabDataOperationHandler {
   protected:
    OpHandler() = default;
...
// -----------------------------------------------------------------------------
class SimpleGraph::VertexAddOperation : public collabserver::CollabDataOperation {
   private:
    UUID _vertexID;
   ...
   public:
    ...
    void accept(collabserver::CollabDataOperationHandler& handler) const override;
...
// -----------------------------------------------------------------------------
class SimpleGraph::VertexRemoveOperation : public collabserver::CollabDataOperation {
   private:
    UUID _vertexID;
    Timestamp _timestamp = {0};
...
// -----------------------------------------------------------------------------
class SimpleGraph::EdgeAddOperation : public collabserver::CollabDataOperation {
   private:
    UUID _fromID;
    UUID _toID;
    Timestamp _timestamp = {0};
   ...
   public:
    ...
    EdgeAddOperation(const UUID& fromID, const UUID& toID, const Timestamp& time);
...
// -----------------------------------------------------------------------------
class SimpleGraph::EdgeRemoveOperation : public collabserver::CollabDataOperation {
   private:
    UUID _fromID;
    UUID _toID;
    Timestamp _timestamp = {0};
   ...
   public:
    ...
    EdgeRemoveOperation(const UUID& fromID, const UUID& toID, const Timestamp& time);
...
// -----------------------------------------------------------------------------
class SimpleGraph::AttributeAddOperation : public collabserver::CollabDataOperation {
   private:
    UUID _vertexID;
    Timestamp _timestamp = {0};
   ...
   public:
    ...
    AttributeAddOperation(const std::string& id, const Timestamp& time, const std::string& name,
...
// -----------------------------------------------------------------------------
class SimpleGraph::AttributeRemoveOperation : public collabserver::CollabDataOperation {
   private:
    UUID _vertexID;
    Timestamp _timestamp = {0};
    std::string _attributeName;
   ...
   public:
    ...
    AttributeRemoveOperation(const std::string& id, const Timestamp& time, const std::string& name);
...
// -----------------------------------------------------------------------------
class SimpleGraph::AttributeSetOperation : public collabserver::CollabDataOperation {
   private:
    UUID _vertexID;
    Timestamp _timestamp = {0};
    std::string _attributeName;
   ...
   public:
    ...
    AttributeSetOperation(const std::string& id, const Timestamp& time, const std::string& name,
