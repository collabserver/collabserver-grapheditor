...
const SimpleGraph::UUID& SimpleGraph::EdgeIterator::current() const { return *_it; }
...
SimpleGraph::VertexDescriptor::VertexDescriptor(const SimpleGraph::UUID& id, const _AttributeMap& attributes,
                                                const _EdgeSet& edges)
    : _id(id), _content(attributes), _edges(edges) {}

const SimpleGraph::UUID& SimpleGraph::VertexDescriptor::id() const { return _id; }

SimpleGraph::EdgeIterator SimpleGraph::VertexDescriptor::edges() const { return EdgeIterator(_edges); }

SimpleGraph::AttributeIterator SimpleGraph::VertexDescriptor::attributes() const { return AttributeIterator(_content); }
